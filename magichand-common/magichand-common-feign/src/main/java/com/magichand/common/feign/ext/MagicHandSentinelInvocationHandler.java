 ...
 */
@Slf4j
public class MagicHandSentinelInvocationHandler implements InvocationHandler {
	...
	MagicHandSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MagicHandSentinelInvocationHandler other = (MagicHandSentinelInvocationHandler) obj;
