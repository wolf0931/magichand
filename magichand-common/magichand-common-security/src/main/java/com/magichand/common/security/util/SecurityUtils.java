package com.magichand.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public MagicHandUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof MagicHandUser) {
			return (MagicHandUser) principal;
		}
		return null;
	}
