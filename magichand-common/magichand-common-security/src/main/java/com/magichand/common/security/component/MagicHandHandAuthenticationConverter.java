 ...
 */
public class MagicHandHandAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			MagicHandUser user = new MagicHandUser(id, deptId, username, N_A, true, true, true, true, authorities);
