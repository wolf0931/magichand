 ...
 */
@Slf4j
public class MagicHandFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public MagicHandFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
